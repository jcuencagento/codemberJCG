function countWords (message) {
    ...
    const array_words = message.toLowerCase().split(' ');
    const array_unique_words = new Set(array_words);
    array_unique_words.forEach(word_to_count => {
        let word_count = 0;
